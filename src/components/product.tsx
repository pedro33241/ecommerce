...
import { dataProductLuz } from "./mook/dataProductLuz";
...
export function Product() {
    ...
    const filterProductLuz = dataProductLuz.filter(item => 
        item.nameProduct.toLowerCase().includes(data.toLowerCase())
    );
        ...
        <>
            <div className="mt-36">
               ...
               <button 
                    ...
                    <button 
                        className={`bg-[#fffec1] text-[#ffd700] flex flex-row gap-4 pt-4 rounded-[15px] w-[210px] h-[60px] justify-center px-2 py-auto text-[14px] font-medium ${activeTab === 0 ? "active" : ""}`}
                    ...
                    >
                        <Image 
                            ...
                            height={24}
                        />
                        <span className="mt-1">Iluminação</span>
                    </button>
                </div>
...
{activeTab === 1 && (
                        <div> 
                            <h2 className="ml-10 font-semibold lg:text-[24px] sm:text-[19px]">Melhores Lâmpadas</h2>
                            <div className="lg:ml-10 sm:ml-0 flex flex-wrap justify-center gap-10 mt-24">
