...
export function Footer() {
 ...
 <div className="flex flex-col gap-3">
                            ...
                            <p className="text-[12px] font-bold">SEDE: Luanda – Talatona | Bairro Camama, Rua nº 8, Av. Principal do Camama, Casa nº 135</p>
                        </div>
                        <div className="flex flex-col gap-3">
                            ...
                            <div className="flex flex-row gap-4 mt-1">
                                ...
                                <Link href="https://www.linkedin.com/company/dbsd-com%C3%A9rcio-e-presta%C3%A7%C3%A3o-de-servi%C3%A7os-su-lda/?viewAsMember=true" className="text-blue-700 hover:opacity-80" target="_blank" aria-label="LinkedIn">
