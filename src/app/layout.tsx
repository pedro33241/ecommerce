  ...
  return (
    <html lang="pt">
      <head>
        ...
        <meta name="description" content="DBSD é a empresa que oferece para você as melhores soluções em termos de produtos ou artigos BOSCH, FLUX, TRAMONTINA, YATO e outros materiais diversos para, oficina, metalomecânica, construção, restaurantes, aproveite já e acesse o ..." />
        ...
        <meta property="og:description" content="DBSD é a empresa que oferece para você as melhores soluções em termos de produtos ou artigos BOSCH, FLUX, TRAMONTINA, YATO e outros materiais diversos para, oficina, metalomecânica, construção, restaurantes, aproveite já e acesse o ..." />
